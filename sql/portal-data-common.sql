...
insert into Region (regionId, countryId, regionCode, name, active_) values (9012, 9, 'JP-08', '茨城県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9013, 9, 'JP-09', '栃木県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9014, 9, 'JP-10', '群馬県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9008, 9, 'JP-11', '埼玉県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9009, 9, 'JP-12', '千葉県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9010, 9, 'JP-13', '東京都', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9011, 9, 'JP-14', '神奈川県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9017, 9, 'JP-15', '新潟県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9018, 9, 'JP-16', '富山県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9019, 9, 'JP-17', '石川県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9020, 9, 'JP-18', '福井県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9015, 9, 'JP-19', '山梨県', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (9016, 9, 'JP-20', '長野県', TRUE);
