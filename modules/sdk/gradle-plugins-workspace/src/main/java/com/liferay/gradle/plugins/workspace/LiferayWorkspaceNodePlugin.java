 ...
 * @author Drew Brokke
 */
public class LiferayWorkspaceNodePlugin extends NodePlugin {

	public LiferayWorkspaceNodePlugin() {
	...
	public void apply(Project project) {
		...
		_ensureLTS(nodeExtension, project);

		_ensureMinimumVersions(nodeExtension);
	}

	private void _ensureLTS(NodeExtension nodeExtension, Project project) {
	...
	private void _ensureMinimumVersions(NodeExtension nodeExtension) {
		try {
