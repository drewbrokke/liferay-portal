...
public class VersionUtil {
	...
	public static boolean isDXPVersion(String targetPlatformVersion) {
		...
		Matcher matcherQuarter = _externalQuarterVersionPattern.matcher(targetPlatformVersion);

		return matcher.matches() || matcherQuarter.matches();
	}
