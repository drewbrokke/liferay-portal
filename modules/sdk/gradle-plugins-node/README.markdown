...
`lts` | `String` | `null` | An LTS codename matching one of the codenames found in the Node JS [Release Schedule Table](https://github.com/nodejs/Release?tab=readme-ov-file#release-schedule) or [End-of-Life Releases Table](https://github.com/nodejs/Release?tab=readme-ov-file#end-of-life-releases). The latest Node version under that LTS will be used. If an invalid value is provided, the declared `nodeVersion` will be used.
