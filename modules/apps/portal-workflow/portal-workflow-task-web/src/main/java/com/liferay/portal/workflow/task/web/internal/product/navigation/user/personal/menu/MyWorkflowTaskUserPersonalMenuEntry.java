...
package com.liferay.portal.workflow.task.web.internal.product.navigation.user.personal.menu;
...
@Component(
	immediate = true,
	property = {
		"product.navigation.user.personal.menu.entry.order:Integer=500",
		"product.navigation.user.personal.menu.group:Integer=200"
	},
	service = UserPersonalMenuEntry.class
)
public class MyWorkflowTaskUserPersonalMenuEntry
