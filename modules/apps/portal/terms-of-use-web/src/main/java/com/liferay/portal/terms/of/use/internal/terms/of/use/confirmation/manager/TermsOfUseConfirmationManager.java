...
@Component(
	...
	service = PortalTermsOfUseConfirmationManager.class
)
public class PortalTermsOfUseConfirmationManager {
	...
	private boolean _isConfirmedInPortalPreferences(long userId) {
		...
		return GetterUtil.getBoolean(
			portalPreferences.getValue(
				_NAMESPACE, _PORTAL_TERMS_OF_USE_CONFIRMED));
	}
	...
	private static final String _PORTAL_TERMS_OF_USE_CONFIRMED =
		"_PORTAL_TERMS_OF_USE_CONFIRMED";

	private static final String _NAMESPACE =
		PortalTermsOfUsePortletKeys.PORTAL_TERMS_OF_USE;

	private static final Log _log = LogFactoryUtil.getLog(
		PortalTermsOfUseConfirmationManager.class);
