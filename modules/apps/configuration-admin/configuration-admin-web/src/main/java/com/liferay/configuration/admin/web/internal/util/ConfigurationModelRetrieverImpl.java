...
public class ConfigurationModelRetrieverImpl
	...
	protected String getNegativePropertyFilterString(String key, String value) {
		if (Validator.isNull(key) || Validator.isNull(value)) {
			return StringPool.BLANK;
		}

		return StringBundler.concat(
			StringPool.OPEN_PARENTHESIS, StringPool.EXCLAMATION,
			getPropertyFilterString(key, value), StringPool.CLOSE_PARENTHESIS);
	}
