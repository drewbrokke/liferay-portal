...
public class ActionHelper {
	...
	public List<Country> getCommerceCountries(PortletRequest portletRequest)
	...
	public Country getCommerceCountry(RenderRequest renderRequest)
		throws PortalException {
		...
		if (commerceCountryId > 0) {
			return _countryService.getCountry(commerceCountryId);
		}

		return null;
	}

	public Region getCommerceRegion(RenderRequest renderRequest)
		throws PortalException {
		...
		if (commerceRegionId > 0) {
			return _regionService.getRegion(commerceRegionId);
		}
