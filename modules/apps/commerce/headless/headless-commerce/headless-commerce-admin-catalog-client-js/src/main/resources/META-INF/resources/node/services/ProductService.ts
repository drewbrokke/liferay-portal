...
export class ProductService {
    ...
    public deleteProductByExternalReferenceCode({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/products/by-externalReferenceCode/{externalReferenceCode}',
            path: {
    ...
    public deleteProductByExternalReferenceCodeByVersion({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/products/by-externalReferenceCode/{externalReferenceCode}/by-version/{version}',
            path: {
                'externalReferenceCode': externalReferenceCode,
                'version': version,
            },
    ...
    public postProductByExternalReferenceCodeClone({
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/products/by-externalReferenceCode/{externalReferenceCode}/clone',
            path: {
                'externalReferenceCode': externalReferenceCode,
            },
            query: {
    ...
    public deleteProductByVersion({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/products/{id}/by-version/{version}',
            path: {
                'id': id,
                'version': version,
            },
