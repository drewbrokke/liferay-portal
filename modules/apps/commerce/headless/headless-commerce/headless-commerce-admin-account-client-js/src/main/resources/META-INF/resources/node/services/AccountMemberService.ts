...
export class AccountMemberService {
    ...
    public getAccountByExternalReferenceCodeAccountMembersPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounts/by-externalReferenceCode/{externalReferenceCode}/accountMembers',
            path: {
    ...
    public deleteAccountByExternalReferenceCodeAccountMember({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/accounts/by-externalReferenceCode/{externalReferenceCode}/accountMembers/{userId}',
            path: {
                'externalReferenceCode': externalReferenceCode,
                'userId': userId,
            },
    ...
    public getAccountIdAccountMembersPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounts/{id}/accountMembers',
            path: {
                'id': id,
            },
            query: {
    ...
    public deleteAccountIdAccountMember({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/accounts/{id}/accountMembers/{userId}',
            path: {
                'id': id,
                'userId': userId,
            },
