...
export class MessageBoardThreadService {
    ...
    public getMessageBoardSectionMessageBoardThreadsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/message-board-sections/{messageBoardSectionId}/message-board-threads',
            path: {
    ...
    public getMessageBoardThreadsRankedPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/message-board-threads/ranked',
            query: {
    ...
    public deleteMessageBoardThread({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/message-board-threads/{messageBoardThreadId}',
            path: {
    ...
    public deleteMessageBoardThreadMyRating({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/message-board-threads/{messageBoardThreadId}/my-rating',
            path: {
                'messageBoardThreadId': messageBoardThreadId,
            },
        });
    ...
    public getMessageBoardThreadPermissionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/message-board-threads/{messageBoardThreadId}/permissions',
            path: {
                'messageBoardThreadId': messageBoardThreadId,
            },
            query: {
    ...
    public putMessageBoardThreadSubscribe({
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/message-board-threads/{messageBoardThreadId}/subscribe',
            path: {
                'messageBoardThreadId': messageBoardThreadId,
            },
        });
    ...
    public putMessageBoardThreadUnsubscribe({
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/message-board-threads/{messageBoardThreadId}/unsubscribe',
            path: {
                'messageBoardThreadId': messageBoardThreadId,
            },
        });
    ...
    public getSiteMessageBoardThreadsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/sites/{siteId}/message-board-threads',
            path: {
                'siteId': siteId,
            },
            query: {
    ...
    public getSiteMessageBoardThreadByFriendlyUrlPath({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/sites/{siteId}/message-board-threads/by-friendly-url-path/{friendlyUrlPath}',
            path: {
                'siteId': siteId,
    ...
    public getSiteMessageBoardThreadPermissionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/sites/{siteId}/message-board-threads/permissions',
            path: {
                'siteId': siteId,
            },
            query: {
