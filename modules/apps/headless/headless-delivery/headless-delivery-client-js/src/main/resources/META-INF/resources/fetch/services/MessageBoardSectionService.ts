...
export class MessageBoardSectionService {
    ...
    public deleteMessageBoardSection({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/message-board-sections/{messageBoardSectionId}',
            path: {
    ...
    public getMessageBoardSectionPermissionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/message-board-sections/{messageBoardSectionId}/permissions',
            path: {
                'messageBoardSectionId': messageBoardSectionId,
            },
            query: {
    ...
    public putMessageBoardSectionSubscribe({
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/message-board-sections/{messageBoardSectionId}/subscribe',
            path: {
                'messageBoardSectionId': messageBoardSectionId,
            },
        });
    ...
    public putMessageBoardSectionUnsubscribe({
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/message-board-sections/{messageBoardSectionId}/unsubscribe',
            path: {
                'messageBoardSectionId': messageBoardSectionId,
            },
        });
    ...
    public getMessageBoardSectionMessageBoardSectionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/message-board-sections/{parentMessageBoardSectionId}/message-board-sections',
            path: {
    ...
    public getSiteMessageBoardSectionByFriendlyUrlPath({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/sites/{siteId}/message-board-section/by-friendly-url-path/{friendlyUrlPath}',
            path: {
                'siteId': siteId,
    ...
    public getSiteMessageBoardSectionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/sites/{siteId}/message-board-sections',
            path: {
                'siteId': siteId,
            },
            query: {
    ...
    public getSiteMessageBoardSectionPermissionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/sites/{siteId}/message-board-sections/permissions',
            path: {
                'siteId': siteId,
            },
            query: {
