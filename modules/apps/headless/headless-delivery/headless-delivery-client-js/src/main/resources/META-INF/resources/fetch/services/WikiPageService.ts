...
export class WikiPageService {
    ...
    public deleteSiteWikiPageByExternalReferenceCode({
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/sites/{siteId}/wiki-pages/by-external-reference-code/{externalReferenceCode}',
            path: {
                'siteId': siteId,
    ...
    public getWikiNodeWikiPagesPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/wiki-nodes/{wikiNodeId}/wiki-pages',
            path: {
    ...
    public getWikiPageWikiPagesPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/wiki-pages/{parentWikiPageId}/wiki-pages',
            path: {
    ...
    public getWikiPagePermissionsPage({
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/wiki-pages/{wikiPageId}/permissions',
            path: {
                'wikiPageId': wikiPageId,
            },
            query: {
    ...
    public putWikiPageSubscribe({
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/wiki-pages/{wikiPageId}/subscribe',
            path: {
                'wikiPageId': wikiPageId,
            },
        });
    ...
    public putWikiPageUnsubscribe({
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/wiki-pages/{wikiPageId}/unsubscribe',
            path: {
                'wikiPageId': wikiPageId,
            },
        });
