...
import com.liferay.headless.admin.user.client.resource.v1_0.CountryResource;
...
public abstract class BaseCountryResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.admin.user.dto.v1_0.Country.class)) {
	...
	@Inject
	private com.liferay.headless.admin.user.resource.v1_0.CountryResource
		_countryResource;
