...
<liferay-ui:error exception="<%= RequiredRoleException.MustNotUnsetAdminRoleToLastAdminUser.class %>" message="at-least-one-administrator-is-required" />
<liferay-ui:error exception="<%= RequiredRoleException.MustNotUnsetUserRole.class %>" message="user-role-could-not-be-removed" />
