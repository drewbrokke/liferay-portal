...
public class AccountEntryUserRelUtil {
	 ...
	 */
	public static List<AccountEntryUserRel> findByA(long accountEntryId) {
		return getPersistence().findByA(accountEntryId);
	}
	 ...
	 */
	public static List<AccountEntryUserRel> findByA(
		long accountEntryId, int start, int end) {

		return getPersistence().findByA(accountEntryId, start, end);
	}
	 ...
	 */
	public static AccountEntryUserRel findByA_First(
			long accountEntryId,
			OrderByComparator<AccountEntryUserRel> orderByComparator)
		throws com.liferay.account.exception.NoSuchEntryUserRelException {

		return getPersistence().findByA_First(
	 ...
	 */
	public static AccountEntryUserRel fetchByA_First(
		long accountEntryId,
		OrderByComparator<AccountEntryUserRel> orderByComparator) {

		return getPersistence().fetchByA_First(
			accountEntryId, orderByComparator);
	}
	 ...
	 * @throws NoSuchEntryUserRelException if a matching account entry user rel could not be found
	 */
	public static AccountEntryUserRel findByA_Last(
			long accountEntryId,
			OrderByComparator<AccountEntryUserRel> orderByComparator)
		throws com.liferay.account.exception.NoSuchEntryUserRelException {

		return getPersistence().findByA_Last(accountEntryId, orderByComparator);
	}
	 ...
	 */
	public static AccountEntryUserRel fetchByA_Last(
		long accountEntryId,
		OrderByComparator<AccountEntryUserRel> orderByComparator) {

		return getPersistence().fetchByA_Last(
			accountEntryId, orderByComparator);
	}
	 ...
	 */
	public static AccountEntryUserRel[] findByA_PrevAndNext(
			long accountEntryUserRelId, long accountEntryId,
			OrderByComparator<AccountEntryUserRel> orderByComparator)
		throws com.liferay.account.exception.NoSuchEntryUserRelException {

		return getPersistence().findByA_PrevAndNext(
	 ...
	 * @param accountEntryId the account entry ID
	 */
	public static void removeByA(long accountEntryId) {
		getPersistence().removeByA(accountEntryId);
	}
	 ...
	 */
	public static int countByA(long accountEntryId) {
		return getPersistence().countByA(accountEntryId);
	}
