...
public class AccountEntryOrganizationRelUtil {
	 ...
	 */
	public static List<AccountEntryOrganizationRel> findByAEI(
		long accountEntryId) {
	 ...
	 */
	public static AccountEntryOrganizationRel findByAEI_First(
			long accountEntryId,
			OrderByComparator<AccountEntryOrganizationRel> orderByComparator)
	 ...
	 */
	public static AccountEntryOrganizationRel fetchByAEI_First(
		long accountEntryId,
		OrderByComparator<AccountEntryOrganizationRel> orderByComparator) {
	 ...
	 * @throws NoSuchEntryOrganizationRelException if a matching account entry organization rel could not be found
	 */
	public static AccountEntryOrganizationRel findByAEI_Last(
			long accountEntryId,
			OrderByComparator<AccountEntryOrganizationRel> orderByComparator)
		throws com.liferay.account.exception.
			NoSuchEntryOrganizationRelException {
	 ...
	 */
	public static AccountEntryOrganizationRel fetchByAEI_Last(
		long accountEntryId,
		OrderByComparator<AccountEntryOrganizationRel> orderByComparator) {
	 ...
	 */
	public static AccountEntryOrganizationRel[] findByAEI_PrevAndNext(
	 ...
	 * @throws NoSuchEntryOrganizationRelException if a matching account entry organization rel could not be found
	 */
	public static AccountEntryOrganizationRel findByAEI_O(
			long accountEntryId, long organizationId)
		throws com.liferay.account.exception.
			NoSuchEntryOrganizationRelException {

		return getPersistence().findByAEI_O(accountEntryId, organizationId);
	}
	 ...
	 */
	public static AccountEntryOrganizationRel fetchByAEI_O(
		long accountEntryId, long organizationId) {

		return getPersistence().fetchByAEI_O(accountEntryId, organizationId);
	}
	...
	public static AccountEntryOrganizationRel fetchByAEI_O(
		...
		return getPersistence().fetchByAEI_O(
	 ...
	 */
	public static AccountEntryOrganizationRel removeByAEI_O(
			long accountEntryId, long organizationId)
		throws com.liferay.account.exception.
			NoSuchEntryOrganizationRelException {

		return getPersistence().removeByAEI_O(accountEntryId, organizationId);
	}
	 ...
	 * @return the number of matching account entry organization rels
	 */
	public static int countByAEI_O(long accountEntryId, long organizationId) {
		return getPersistence().countByAEI_O(accountEntryId, organizationId);
	}
