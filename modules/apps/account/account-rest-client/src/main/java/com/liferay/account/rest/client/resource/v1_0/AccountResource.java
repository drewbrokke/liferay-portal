...
public interface AccountResource {
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				parentAccountExternalReferenceCode.toString(),
				"application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/account-rest/v1.0/accounts/by-external-reference-code/{externalReferenceCode}/parent-account-link{parentAccountExternalReferenceCode}",
				externalReferenceCode, parentAccountExternalReferenceCode);
