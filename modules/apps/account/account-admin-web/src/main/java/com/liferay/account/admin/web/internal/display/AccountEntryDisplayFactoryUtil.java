...
public class AccountEntryDisplayFactoryUtil {
	...
	public static AccountEntryDisplay create(
		...
		AccountEntryEmailAddressValidator accountEntryEmailAddressValidator =
			AccountEntryEmailAddressValidatorFactoryUtil.create(
				PortalUtil.getCompanyId(portletRequest), new String[0]);
		...
		String logoURL = accountEntryDisplayAlt.getDefaultLogoURL();
		...
		accountEntryDisplayAlt.setLogoURL(logoURL);
	...
	public static AccountEntryDisplay create(
		...
		if (accountEntry == null) {
			accountEntry = AccountEntryLocalServiceUtil.createAccountEntry(
				accountEntryId);
		...
		return create(accountEntry, portletRequest);
	}
