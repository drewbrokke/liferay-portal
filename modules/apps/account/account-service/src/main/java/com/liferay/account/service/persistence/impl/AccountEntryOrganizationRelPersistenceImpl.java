...
public class AccountEntryOrganizationRelPersistenceImpl
	 ...
	 */
	@Override
	public List<AccountEntryOrganizationRel> findByAEI(long accountEntryId) {
		return findByAEI(
	 ...
	 */
	@Override
	public List<AccountEntryOrganizationRel> findByAEI(
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel findByAEI_First(
			long accountEntryId,
			OrderByComparator<AccountEntryOrganizationRel> orderByComparator)
		throws NoSuchEntryOrganizationRelException {

		AccountEntryOrganizationRel accountEntryOrganizationRel =
			fetchByAEI_First(accountEntryId, orderByComparator);
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel fetchByAEI_First(
		long accountEntryId,
		OrderByComparator<AccountEntryOrganizationRel> orderByComparator) {

		List<AccountEntryOrganizationRel> list = findByAEI(
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel findByAEI_Last(
			long accountEntryId,
			OrderByComparator<AccountEntryOrganizationRel> orderByComparator)
		throws NoSuchEntryOrganizationRelException {

		AccountEntryOrganizationRel accountEntryOrganizationRel =
			fetchByAEI_Last(accountEntryId, orderByComparator);
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel fetchByAEI_Last(
		long accountEntryId,
		OrderByComparator<AccountEntryOrganizationRel> orderByComparator) {
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel[] findByAEI_PrevAndNext(
	...
	protected AccountEntryOrganizationRel getByAEI_PrevAndNext(
		Session session,
		AccountEntryOrganizationRel accountEntryOrganizationRel,
		long accountEntryId,
		OrderByComparator<AccountEntryOrganizationRel> orderByComparator,
	...
	private FinderPath _finderPathFetchByAEI_O;
	private FinderPath _finderPathCountByAEI_O;
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel findByAEI_O(
			long accountEntryId, long organizationId)
		throws NoSuchEntryOrganizationRelException {

		AccountEntryOrganizationRel accountEntryOrganizationRel = fetchByAEI_O(
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel fetchByAEI_O(
		long accountEntryId, long organizationId) {

		return fetchByAEI_O(accountEntryId, organizationId, true);
	}
	...
	public AccountEntryOrganizationRel fetchByAEI_O(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByAEI_O, finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_AEI_O_ACCOUNTENTRYID_2);

			query.append(_FINDER_COLUMN_AEI_O_ORGANIZATIONID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByAEI_O, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccountEntryOrganizationRelPersistenceImpl.fetchByAEI_O(long, long, boolean) with parameters (" +
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchByAEI_O, finderArgs);
				}
	 ...
	 */
	@Override
	public AccountEntryOrganizationRel removeByAEI_O(
			long accountEntryId, long organizationId)
		throws NoSuchEntryOrganizationRelException {

		AccountEntryOrganizationRel accountEntryOrganizationRel = findByAEI_O(
			accountEntryId, organizationId);
	 ...
	 */
	@Override
	public int countByAEI_O(long accountEntryId, long organizationId) {
		FinderPath finderPath = _finderPathCountByAEI_O;
	...
	private static final String _FINDER_COLUMN_AEI_O_ACCOUNTENTRYID_2 =
		"accountEntryOrganizationRel.accountEntryId = ? AND ";

	private static final String _FINDER_COLUMN_AEI_O_ORGANIZATIONID_2 =
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathCountByAEI_O, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByAEI_O, args, accountEntryOrganizationRelModelImpl,
			false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(_finderPathCountByAEI_O, args);
			finderCache.removeResult(_finderPathFetchByAEI_O, args);
		}

		if ((accountEntryOrganizationRelModelImpl.getColumnBitmask() &
			 _finderPathFetchByAEI_O.getColumnBitmask()) != 0) {
	...
	public void activate() {
		...
		_finderPathFetchByAEI_O = new FinderPath(
			entityCacheEnabled, finderCacheEnabled,
		...
		_finderPathCountByAEI_O = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByAEI_O",
			new String[] {Long.class.getName(), Long.class.getName()});
	}
