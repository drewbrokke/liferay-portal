...
public class AccountEntryOrganizationRelLocalServiceImpl
	...
	public AccountEntryOrganizationRel addAccountEntryOrganizationRel(
		...
		AccountEntryOrganizationRel accountEntryOrganizationRel =
			accountEntryOrganizationRelPersistence.fetchByAEI_O(
		...
		accountEntryOrganizationRel = createAccountEntryOrganizationRel(
	...
	public List<AccountEntryOrganizationRel> getAccountEntryOrganizationRels(
		...
		return accountEntryOrganizationRelPersistence.findByAEI(accountEntryId);
	}

	@Override
	public int getAccountEntryOrganizationRelsCount(long accountEntryId) {
		return accountEntryOrganizationRelPersistence.countByAEI(
			accountEntryId);
	}
