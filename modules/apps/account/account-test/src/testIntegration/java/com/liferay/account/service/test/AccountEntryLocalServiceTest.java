...
public class AccountEntryLocalServiceTest {
	...
	public void testAddAccountEntryWithDomains() throws Exception {
		String[] domains = {"test1", "test1.com", "test.1.com", "test-1.com"};
	...
	public void testAddAccountEntryWithInvalidDomains() throws Exception {
		String[] invalidDomains = {
			".domain", "-domain", "domain-", "_invalid", "invalid_",
			"@domain.com", "invalid#domain", "invalid&domain", "invalid!.com",
			"invalid$domain.com", "invalid%.com", "*invalid", "invalid*",
