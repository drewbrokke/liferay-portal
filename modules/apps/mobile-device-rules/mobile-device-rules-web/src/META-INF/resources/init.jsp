...
page import="com.liferay.mobile.device.rules.rule.MDRRuleGroupProcessorUtil" %><%@
...
page import="com.liferay.mobile.device.rules.util.comparator.MDRRuleGroupInstancePriorityComparator" %><%@
page import="com.liferay.mobile.device.rules.web.constants.MDRWebKeys" %><%@
page import="com.liferay.mobile.device.rules.web.search.MDRRuleGroupChecker" %><%@
page import="com.liferay.mobile.device.rules.web.search.MDRRuleGroupDisplayTerms" %><%@
page import="com.liferay.mobile.device.rules.web.search.MDRRuleGroupSearch" %><%@
page import="com.liferay.mobile.device.rules.web.search.MDRRuleGroupSearchTerms" %><%@
