 ...
 * @generated
 */
public abstract class BaseBookmarksEntryUADDisplay extends BaseModelUADDisplay<BookmarksEntry> {
	@Override
	public BookmarksEntry get(Serializable primaryKey)
		throws PortalException {
		return bookmarksEntryLocalService.getBookmarksEntry(Long.valueOf(
				primaryKey.toString()));
	}
	...
	@Override
	protected List<BookmarksEntry> doGetRange(DynamicQuery dynamicQuery,
		int start, int end) {
