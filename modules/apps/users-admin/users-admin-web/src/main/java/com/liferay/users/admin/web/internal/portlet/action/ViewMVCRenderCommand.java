...
import com.liferay.users.admin.constants.UsersManagementToolbarKeys;
import com.liferay.users.admin.user.action.contributor.UserActionContributor;
import com.liferay.users.admin.web.internal.constants.UsersAdminWebKeys;
import com.liferay.users.admin.web.internal.display.context.FilterContributorTracker;
	...
	public String render(
		...
		renderRequest.setAttribute(
			...
			_filterContributorTracker.getFilterContributors(
				UsersManagementToolbarKeys.VIEW_FLAT_USERS));
