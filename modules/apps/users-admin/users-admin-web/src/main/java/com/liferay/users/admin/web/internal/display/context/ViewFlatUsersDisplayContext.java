...
/**
 * @author Pei-JungViewFlatUsersDisplayContext viewFlatUsersDisplayContext = new ViewFlatUsersDisplayContext(request, renderRequest, renderResponse, displayStyle, domain, navigation, status); Lan
 */
