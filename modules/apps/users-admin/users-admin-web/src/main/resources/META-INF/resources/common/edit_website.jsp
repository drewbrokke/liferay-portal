...
<%
String actionName = (String)request.getAttribute(UserFormConstants.ACTION_NAME);
...
if (portletName.equals(UsersAdminPortletKeys.MY_ACCOUNT)) {
	...
	String portletTitle = (String)request.getAttribute(UserFormConstants.PORTLET_TITLE);
