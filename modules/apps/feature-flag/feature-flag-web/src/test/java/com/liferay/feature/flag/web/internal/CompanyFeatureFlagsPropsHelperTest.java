	...
	public void testIsEnabled() {
		...
		withFeatureFlagPropsHelper(
			...
			featureFlagsPropsHelper -> {
				...
				Assert.assertTrue(
					featureFlagsPropsHelper.isEnabled(systemKey1));
				Assert.assertFalse(
					featureFlagsPropsHelper.isEnabled(systemKey2));
				Assert.assertFalse(
					featureFlagsPropsHelper.isEnabled(company1key1));
			});
		...
		withFeatureFlagPropsHelper(
			...
			featureFlagsPropsHelper -> {
				...
				Assert.assertTrue(
					featureFlagsPropsHelper.isEnabled(company1key1));
				Assert.assertFalse(
					featureFlagsPropsHelper.isEnabled(company1key2));
			});
		...
		withFeatureFlagPropsHelper(
			...
			featureFlagsPropsHelper -> {
				...
				Assert.assertFalse(
					featureFlagsPropsHelper.isEnabled(systemKey1));
				Assert.assertTrue(
					featureFlagsPropsHelper.isEnabled(company2key1));
			});
	}

	protected void withFeatureFlagPropsHelper(
		Consumer<FeatureFlagsPropsHelper> featureFlagsPropsHelperConsumer) {
