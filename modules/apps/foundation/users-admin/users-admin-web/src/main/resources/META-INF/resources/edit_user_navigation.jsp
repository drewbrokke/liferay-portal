...
<%
String actionCommandName = (String)request.getAttribute(UserScreenNavigationWebKeys.ACTION_COMMAND_NAME);
String jspPath = (String)request.getAttribute(UserScreenNavigationWebKeys.JSP_PATH);

User selUser = PortalUtil.getSelectedUser(request);

request.setAttribute(UserScreenNavigationWebKeys.SELECTED_USER, selUser);
%>
