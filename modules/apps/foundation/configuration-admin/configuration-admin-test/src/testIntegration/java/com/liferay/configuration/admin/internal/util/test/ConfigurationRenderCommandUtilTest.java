...
public class ConfigurationRenderCommandUtilTest {

	@Before
	public void setUp() throws Exception {
		_bundle = FrameworkUtil.getBundle(
			ConfigurationRenderCommandUtilTest.class);
	...
	@Test
	public void testGetConfigurationRenderCommand() {
		ConfigurationRenderCommand configurationRenderCommand =
			new TestRenderCommand();

		_serviceRegistration = _bundleContext.registerService(
			ConfigurationRenderCommand.class, configurationRenderCommand,
			_properties);

		Assert.assertEquals(
			configurationRenderCommand,
			ConfigurationRenderCommandUtil.getConfigurationRenderCommand(
				_configuration.getPid()));
	}

	@Test
	public void testGetFactoryInstancesListRenderCommand() {
		FactoryInstancesListRenderCommand factoryInstancesListRenderCommand =
			new TestRenderCommand();

		_serviceRegistration = _bundleContext.registerService(
			FactoryInstancesListRenderCommand.class,
			factoryInstancesListRenderCommand, _properties);

		Assert.assertEquals(
			factoryInstancesListRenderCommand,
			ConfigurationRenderCommandUtil.getFactoryInstancesListRenderCommand(
				_configuration.getPid()));
	}
	...
	private class TestRenderCommand
