...
@Component(
	...
	property = {
		...
		"mvc.command.name=/users_admin/manage_user_associated_data_entity_types"
	},
...
public class ManageUserAssociatedDataEntityTypesMVCRenderCommand
	...
	public String render(
		...
		String bundleId = ParamUtil.getString(renderRequest, "bundleId");
		long userId = ParamUtil.getLong(renderRequest, "userId");

		List<UADEntityTypeComposite> entityTypeComposites =
			_uadRegistry.getUADEntityTypeComposites(userId, bundleId);
