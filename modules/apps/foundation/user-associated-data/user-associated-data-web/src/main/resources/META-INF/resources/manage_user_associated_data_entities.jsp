...
>
	...
	>
		...
		<liferay-ui:search-container-column-text
			href="${entityTypeComposite.getEditURL(uadEntity, liferayPortletRequest, liferayPortletResponse)}"
			name="edit-url"
			value="${entityTypeComposite.getEditURL(uadEntity, liferayPortletRequest, liferayPortletResponse)}"
		/>
