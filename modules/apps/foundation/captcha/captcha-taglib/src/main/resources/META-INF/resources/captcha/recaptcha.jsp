...
<c:if test="<%= captchaEnabled %>">
	<script src="<%= captchaSettings.getReCaptchaScriptUrl() %>?hl=<%= locale.getLanguage() %>" type="text/javascript"></script>

	<div class="g-recaptcha" data-sitekey="<%= captchaSettings.getReCaptchaPublicKey() %>"></div>

	<noscript>
		<div style="height: 525px; width: 302px;">
			<div style="height: 525px; position: relative; width: 302px;">
				<div style="height: 525px; position: absolute; width: 302px;">
					<iframe frameborder="0" scrolling="no" src="<%= captchaSettings.getReCaptchaNoScriptUrl() %><%= captchaSettings.getReCaptchaPublicKey() %>" style="border-style: none; height: 525px; width: 302px;"></iframe>
				</div>
