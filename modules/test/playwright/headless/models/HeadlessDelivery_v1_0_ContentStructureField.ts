...
/* tslint:disable */
/* eslint-disable */
import type {HeadlessDelivery_v1_0_Option} from './HeadlessDelivery_v1_0_Option';

/**
 * The list of the content structure's fields.
 */
export type HeadlessDelivery_v1_0_ContentStructureField = {
	 ...
	 */
	readonly 'nestedContentStructureFields'?: Array<HeadlessDelivery_v1_0_ContentStructureField>;

	/**
	 * The list of different possible values.
	 */
	readonly 'options'?: Array<HeadlessDelivery_v1_0_Option>;
