...
import {
	...
	ObjectAdmin_v1_0_ObjectDefinition,
} from '../../utils/headless';
...
const companyObjectDefinition: ObjectAdmin_v1_0_ObjectDefinition = {
	active: true,
...
const siteObjectDefinition: ObjectAdmin_v1_0_ObjectDefinition = {
	active: true,
	externalReferenceCode: 'Test',
	label: {'en-US': 'Test'},
	name: 'Test',
