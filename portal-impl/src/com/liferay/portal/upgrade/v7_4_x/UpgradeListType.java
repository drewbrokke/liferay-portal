...
public class UpgradeListType extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		_addListType("billing", _ACCOUNT_ENTRY_ADDRESS_LIST_TYPE_NAME);
		_addListType(
			"billing-and-shipping", _ACCOUNT_ENTRY_ADDRESS_LIST_TYPE_NAME);
		_addListType("shipping", _ACCOUNT_ENTRY_ADDRESS_LIST_TYPE_NAME);
	...
	private static final String _ACCOUNT_ENTRY_ADDRESS_LIST_TYPE_NAME =
		"com.liferay.account.model.AccountEntry" + ListTypeConstants.ADDRESS;
