...
public class CountryLocalServiceImpl extends CountryLocalServiceBaseImpl {
	...
	public Country addCountry(
		...
		if (fetchCountryByCompanyIdAndA2(serviceContext.getCompanyId(), a2) !=
				null) {

			throw new DuplicateCountryException();
		}

		validate(a2, a3, idd, number);
	...
	@Override
	public Country fetchCountryByCompanyIdAndA2(long countryId, String a2) {
	...
	@Override
	public long getCountriesCountByCompanyId(long companyId) {
	...
	protected void validate(String a2, String a3, String idd, String number)
		throws PortalException {

		if (Validator.isNull(a2) ||
			(Validator.isNotNull(a2) && (a2.length() != 2))) {

			throw new CountryA2Exception();
		}

		if (Validator.isNull(a3) ||
			(Validator.isNotNull(a3) && (a3.length() != 3))) {
