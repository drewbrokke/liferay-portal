...
/**
 * REST endpoints for business events, split out of {@link JiraRestController}
 * so the business-event slice owns its full controller -&gt; service -&gt;
 * client path. The paths are unchanged from the original controller.
 *
 * @author Jenny Chen
 */
@RequestMapping("/jira")
