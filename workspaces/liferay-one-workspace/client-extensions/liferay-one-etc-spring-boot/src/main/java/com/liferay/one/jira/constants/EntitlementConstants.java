...
public interface EntitlementConstants {
	...
	public static final String ATTRIBUTE_NAME_OFFERING = "Offering";

	public static final String ATTRIBUTE_NAME_OFFERING_NAME = "Offering Name";

	public static final String ATTRIBUTE_NAME_SORT_ORDER = "Sort Order";
