...
public class AccountSyncService {
	...
	private void _syncAccountAsset(
		...
		// A project reuses its parent account's data but keeps its own
		// identity: the converter derives these two attributes from the
		// account, so override them for the target being synced.
		...
		_accountAssetService.upsertJSMAccount(externalKey, assetObject);
	}
