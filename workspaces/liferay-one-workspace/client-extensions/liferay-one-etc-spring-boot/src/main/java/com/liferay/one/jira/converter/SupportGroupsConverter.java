 ...
 */
@Component
public class SupportGroupsConverter extends BaseAssetObjectConverter {

	@Override
	public String getExternalKeyAttributeName() {
		throw new UnsupportedOperationException(
			"Object type \"" + SupportGroupsConstants.OBJECT_TYPE_NAME +
				"\" has no external key attribute");
	}

	@Override
	public String getObjectTypeName() {
		return SupportGroupsConstants.OBJECT_TYPE_NAME;
	}
