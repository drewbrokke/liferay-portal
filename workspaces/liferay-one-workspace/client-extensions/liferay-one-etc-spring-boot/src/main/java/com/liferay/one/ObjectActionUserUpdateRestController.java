 ...
 * @author Drew Brokke
 */
@RequestMapping("/object/action/user/update")
@RestController
public class ObjectActionUserUpdateRestController
	...
	public void post(@RequestBody String json) throws Exception {
		...
		if (_log.isInfoEnabled()) {
			_log.info(
				"User " + classPK + " was updated, triggering a sync to JSM");
		}
	...
	private static final Log _log = LogFactory.getLog(
		ObjectActionUserUpdateRestController.class);
