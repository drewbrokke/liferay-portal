...
if (!customElements.get('liferay-sample-etc-frontend-3-multiple-cx-with-import-map-custom-element')) {
	customElements.define(
		'liferay-sample-etc-frontend-3-multiple-cx-with-import-map-custom-element',
		CustomElement
	);
}
